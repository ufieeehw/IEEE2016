...
class DetectQRCode(object):
    ...
    def __init__(self, qr_code_count, timeout, image_topic):
        ...
        self.image_sub = rospy.Subscriber("/" + image_topic + "/image_raw",Image_msg,self.image_recieved)
        self.cam_info_sub = rospy.Subscriber("/" + image_topic + "/camera_info",CameraInfo,self.save_camera_info)
