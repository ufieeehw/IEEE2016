...
void uart_init() {
	...
	uart_usb.CTRLA = USART_RXCINTLVL_HI_gc; // Set the interrupt priority of the receive flag, but not the DREIF, since the DREIF will fire as soon as the data register is empty.
